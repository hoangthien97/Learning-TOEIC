								...
								<div class="widget-body">
									<div class="widget-main">
										<h4 class="header blue lighter bigger">
											<i class="ace-icon fa fa-coffee green"></i> Thêm câu hỏi bài
											tập đọc
										</h4>
										...
										<form
											action="Themcauhoibtdoc?readexeriseid=<%=request.getAttribute("readexeriseid")%>"
											method="POST" enctype="multipart/form-data">
											<fieldset>
												<label class="block clearfix"> <%=request.getAttribute("msgthemcauhoibtdoc") != null
					? request.getAttribute("msgthemcauhoibtdoc")
					: " "%>
												</label> <label class="block clearfix"> Thêm file excel: <input
													type="file" name="file"
												...
												<div class="clearfix">
													...
													<button type="submit"
														...
														<i class="ace-icon fa fa-key"></i> <span
															class="bigger-110">Thêm câu hỏi bài tập đọc</span>
													</button>
