			...
			<div class="main-content">
				<div class="main-content-inner">
					...
					<div class="page-content">
							...
							<c:if test="${msgdstuvung!=null}">
								<h4 class="pink">								
										<a class="green" data-toggle="modal">${msgdstuvung}</a>
								</h4>
											...
											<table id="simple-table" class="table  table-bordered table-hover">
												<thead>
													<tr>
														...
														<th class="center">
															Thêm nôi dung chủ đề
														</th>
														<th class="center">
															Checked nội dung chủ đề
														</th>
													</tr>
												</thead>
												<tbody>
													
													<c:forEach items="${danhsachtuvung}" var ="list">
														<tr>
															<td class="center">
															...
															<td class="center">
																<a class="green" href="Themndchudetuvung?vocabularyguidelineid=${list.vocabularyguidelineid}">
																	<i class="ace-icon fa fa-pencil bigger-130"></i>
																</a>
															</td>
															<td class="center">
																<ul class="list-unstyled">
																	<c:if test="${list.checknoidung==1}">
																		<li>
																			<i class="ace-icon fa fa-check-square-o"></i>														
																		</li>	
																	</c:if>	
																	<c:if test="${list.checknoidung==0}">
																		<li>
											...
											<div>
												<ul class="pagination">
													<c:if test="${numberpage == 1}">
													   ...
													   <li><a href = "Hienthidstuvung?pageid=${numberpage+1}">Next</a></li>
												   </c:if>
												   <c:if test="${numberpage == maxpageid}">
													   <li><a href = "Hienthidstuvung?pageid=${numberpage-1}">Prev</a></li>
