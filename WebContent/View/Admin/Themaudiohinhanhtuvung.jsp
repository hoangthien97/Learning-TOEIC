								...
								<div class="widget-body">
									<div class="widget-main">
										<h4 class="header blue lighter bigger">
											<i class="ace-icon fa fa-coffee green"></i> Thêm audio hình
											ảnh hướng dẫn từ vựng
										</h4>

										<div class="space-6"></div>

										<form action="Themaudiohinhanhtuvung" method="POST"
											enctype="multipart/form-data">
											<fieldset>
												<label class="block clearfix"> <%=request.getAttribute("msgthemaudiohinhanhtuvung") != null
					? request.getAttribute("msgthemaudiohinhanhtuvung")
					: " "%>
												</label>
												...
												<div class="clearfix">
													...
													<input type="submit" value="Thêm audio và hình ảnh"
														...
														id="addFile" type="button" value="Thêm choose file"
