...
<title>Thêm hình bài tập đọc</title>
<link rel="stylesheet"
								...
								<div class="widget-body">
									<div class="widget-main">
										<h4 class="header blue lighter bigger">
											<i class="ace-icon fa fa-coffee green"></i> Thêm ảnh cho bài
											tập đọc
										</h4>
										...
										<form
											action="Themhinhbtdoc?readexeriseid=<%=request.getAttribute("readexeriseid")%>"
											method="POST" enctype="multipart/form-data">
											<fieldset>
												<label class="block clearfix"> <%=request.getAttribute("msgthemhinhbtdoc") != null ? request.getAttribute("msgthemhinhbtdoc") : " "%>
												...
												<div class="clearfix">
													...
													<button type="submit"
														...
														<i class="ace-icon fa fa-key"></i> <span
															class="bigger-110">Thêm ảnh bài tập đọc</span>
													</button>
