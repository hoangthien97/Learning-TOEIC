			...
			<div class="main-content-inner">
				<div class="breadcrumbs ace-save-state" id="breadcrumbs">
					<ul class="breadcrumb">
						...
						<li><a class="active">Quản lý danh sách bài tập đọc</a></li>
				...
				<div class="page-content">
					...
					<c:if test="${msgquanlydsbtdoc!=null}">
						<h4 class="pink">
							<a class="green" data-toggle="modal">${msgquanlydsbtdoc}</a>
						</h4>
								...
								<div class="col-xs-12">
									<table id="simple-table"
										...
										<tbody>
											...
											<c:forEach items="${danhsachqlbtdoc}" var="list">
												<tr>
													...
													<td class="center"><a class="red"
														href="Xoabaihdbtdoc?Hienthidsbtdoc?pageid=${list.readexeriseid}">
															<i class="ace-icon fa fa-trash-o bigger-130"></i>
													</a></td>

													<td class="center"><a class="green"
														href="Themcauhoibtdoc?readexeriseid=${list.readexeriseid}">
									...
									<div>
										<ul class="pagination">
											<c:if test="${numberpage == 1}">
												...
												<li><a href="Hienthidsbtdoc?pageid=${numberpage+1}">Next</a></li>
											</c:if>
											<c:if test="${numberpage == maxpageid}">
												<li><a href="Hienthidsbtdoc?pageid=${numberpage-1}">Prev</a></li>
							...
							<div class="row">
								<div class="col-xs-12">
									<button type="button"
										...
										data-target="#myModal">Thêm đề bài tập đọc</button>
				...
				<div class="modal-content">
									...
									<div class="form-group">
										...
										<div class="col-sm-9">
											<input type="text" id="form-field-1-1"
												placeholder="Tên đề thi" class="form-control"
												name="readname" />
										</div>
									</div>
					...
					<div class="modal-footer">
						<button class="btn btn-info" type="submit">
							<i class="ace-icon fa fa-check bigger-110"></i> Thêm tên bài tập
							đọc
						</button>
					</div>
				</div>
