								...
								<div class="widget-body">
									<div class="widget-main">
										<h4 class="header blue lighter bigger">
											<i class="ace-icon fa fa-coffee green"></i> Thêm nội dung chủ
											đề từ vựng
										</h4>
										...
										<form
											action="Themndchudetuvung?vocabularyguidelineid=<%=request.getAttribute("vocabularyguidelineid")%>"
											method="POST" enctype="multipart/form-data">
											<fieldset>
												<label class="block clearfix"> <%=request.getAttribute("msgthemndchudetuvung") != null
					? request.getAttribute("msgthemndchudetuvung")
					: " "%>
												...
												<div class="clearfix">
													...
													<button type="submit"
														...
														<i class="ace-icon fa fa-key"></i> <span
															class="bigger-110">Thêm nội dung chủ đề từ vựng</span>
													</button>
