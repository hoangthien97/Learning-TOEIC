				...
				<div class="active item">
					<div class="container">
						<div class="row">
							...
							<div class="span6">
								<img src="Template/Frontend/img/slide/slide1.jpg" height="350px"
									width="350px">
							</div>
		...
		<div class="row feature-box">
			...
			<div class="span4">
				<a href="#" data-toggle="modal" data-target="#myModal"> <img
					src="Template/Frontend/Image/guideline.png">
				</a>
			...
			<div class="span4">
				<a href="" data-toggle="modal" data-target="#myModal1"> <img
					src="Template/Frontend/Image/exercises.png">
				</a>
			...
			<div class="span4">
				<a href="Hienthidsdethi?pageid=1"> <img
					src="Template/Frontend/Image/thitoeic.png">
				</a>
				<h2>Đề thi thử</h2>
				...
				<div class="modal-body">
					...
					<div class="media">
						<a class="pull-left"><img
							src="Template/Frontend/Image/loaibtnghe.png" class="media-object"
							alt='' /></a>
					...
					<div class="media">
						<a class="pull-left"><img
							src="Template/Frontend/Image/loaibtdoc.png" class="media-object"
							alt='' /></a>
						<div class="media-body">
							<h4>
								<a href="DsbaihdnguphapForward?pageid=1">Bài hướng dẫn phần
									ngữ pháp</a>
							</h4>
						</div>
					</div>
