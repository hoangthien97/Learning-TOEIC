...
public class GrammarguidelinemanageDAO {
	...
	public static List<Grammarguideline> Displaysgrammarguidelinemanage(HttpServletRequest request, int start,
	...
	public static String Uploadimagegrammerguideline(Connection conn, HttpServletRequest request,
			HttpServletResponse response, int grammarguidelineid) throws ServletException, IOException {
		String test = "";
	...
	public static int Retrieveidgrammarguideline(HttpServletRequest request, Connection conn,
			Grammarguideline grammarguideline) {
		...
		String sql = "select grammarguidelineid from grammarguideline where grammarname='"
				+ grammarguideline.getGrammarname() + "'";
	...
	public static boolean Insertgrammarguidelinecontent(HttpServletRequest request, Connection conn,
			Grammarguideline grammarguideline, int id) {
		PreparedStatement ptmt = null;
